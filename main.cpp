...
private:
    ...
    void createComputeDescriptorSetLayout()
    {
        ...
        // Binding 0 - Storage buffer for last frame
        layoutBindings[0].binding = 0;
        layoutBindings[0].descriptorCount = 1;
        layoutBindings[0].descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
        layoutBindings[0].stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;

        // Binding 1 - Storage buffer for current frame
    ...
    void createGraphicsPipeline()
    {
        ...
        pipelineLayoutInfo.setLayoutCount = 1; // Include the computeDescriptorSetLayout
        pipelineLayoutInfo.pSetLayouts = &computeDescriptorSetLayout;

        VkDescriptorSetLayout setLayouts[] = {graphicsDescriptorSetLayout};
        pipelineLayoutInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO;
    ...
    void createDescriptorPool()
    {
        ...
        poolInfo.maxSets = 2 * MAX_FRAMES_IN_FLIGHT; // Both compute and graphics sets
